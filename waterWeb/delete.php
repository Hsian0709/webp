<?php
    ...
    $table="";
    if(isset($_GET['tabletype'])&&($tabletype!="安全性")) // tabletype= 縣市 漁港 海岸 溪河 水庫
    {
    ...
    else// tabletype="安全性"
    {
        ...
        {
            $sql="SELECT $watertype.名稱,水域活動限制,看守人員,是否為危險水域 FROM `安全性`,`$watertype`WHERE 安全性.水域ID = $watertype.水域ID;";
            $rows = $pdo->bindQuery($sql);
        ...
        <div style="background-color:#E0E0E0;width:770px;height:550px;position:absolute;top:18%;left:31%;">
            <div style="margin:35px 50px;">
                ...
                <form method="get" action="">
                    ...
                    <input style="position:absolute ;left:40%;top:24%" class="btn btn-outline-secondary btn-sm" type="submit" value="Submit">
                </form>
                <h4>
                    <?php  
                    ...
                    if($tabletype=="安全性"){
                        $watertable='
                            ...
                            <form method="get" action="">
                                ...
                                <input style="position:absolute ;left:40%;top:44%" class="btn btn-outline-secondary btn-sm" type="submit" value="Submit">
                            </form>';
