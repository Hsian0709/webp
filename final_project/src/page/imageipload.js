...
const Imageupload = ({ username , userphoto}) => {
    ...
    const preview = image ? URL.createObjectURL(image) : "https://react.semantic-ui.com/images/wireframe/image.png";
    const handleupload = () => {
    ...
    return (
        <div>
            <IconButton sx={{ width: 85, height: 85 }} aria-label="add" onClick={handleClickOpen}>
                <AddBoxRoundedIcon sx={{ fontSize: 40, mt: 0.1 }} />
            </IconButton>
            <Dialog open={open} onClose={handleClose} fullWidth='md'>
                <DialogTitle>Newpost</DialogTitle>
